...
if __name__ == '__main__':
    ...
    space = {
        ...
        "min_count": 5,
        "batch_size": 128,
        "d_embedding": scope.int(hp.quniform('d_embedding', 16, 32, 1)),
        "epochs": 10,
        "lr": hp.loguniform('lr', np.log(1e-5), np.log(1e-2)),
        "wd": hp.loguniform('wd', np.log(1e-6), np.log(1e-4)),
        "patience": 3,
        "feedforward_num_layers": hp.uniformint('feedforward_num_layers', 1, 3),
        #"embedding_dropout_p": hp.uniform('embedding_dropout_p', 0, 0.7),
        "verbose": True,
