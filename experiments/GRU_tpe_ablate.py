...
from experiments.GRU import hyperopt_objective
...
if __name__ == '__main__':
    for p in [0.025, 0.01]:
        ...
        space.update(
            {"name": "{name}_{version}_leadlag{leadlag}_addtime{add_time}_timestamps{use_timestamps}_allcode{all_code_types}_trainprop{training_proportion}".format_map(space)})
